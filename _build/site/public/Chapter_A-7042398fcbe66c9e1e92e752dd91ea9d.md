...
- Derivative of a sum $\frac{d}{dx}\left(g\left(x\right) + f\left(x\right)\right)$ is just the sum of the derivatives. For example, the derivative of $2x^2 + \frac{2}{x^3}$
